...
If you came here looking for Juice Shop, please use [the official Juice Shop repository](https://github.com/juice-shop/juice-shop).

This repository is a clone of very specifically version 15.0.0 of Juice Shop. It has no history, no branches or tags. It literally
is nothing more than the base 15.0 release. Why do this? Because the labs in the Unixerius' DevSecOps training assume certain features
and URLs to be stuck to a specific version of Juice Shop. And Bjorn and team just move too quickly for me to keep up!
